    ...
    <tbody><!--Cuerpo del delito-->
      ...
      foreach ($arrayDatos as $resultado) {//recorrer los datos de la tabla para insertarlos en los tr
        ...
        <tr>
          ...
          <td class="vacio"><a href="crud_actualizar.php?dni=<?php echo $resultado["dni_empleado"];?>&nombre=<?php echo $resultado["nombre_empleado"];?>&puesto=<?php echo $resultado["puesto_empleado"];?>&sueldo=<?php echo $resultado["sueldo_empleado"];?>"><input type="button" name="act" id="act" value="Modificar"></a></td><!--te lleva a la pagina para actualizar los datos del empleado-->
        </tr>
        <?php
        // code...
      }
