...
<body>
  ...
  define("FICH_REMOTO", 'http://192.168.98.42/f_remoto.txt'); // x.y.w.z es la IP del servidor remoto
  ...
  while ($linea = fgets($fich_remoto)){
    ...
    $contador_linea++ ; // Incrementamos el contador con el no de bytes procesados
  }
  ...
  echo "Total de lineas procesadas: $contador_linea<br />"; // Mostramos el número de bytes leídos (y escritos)
  ?>
</body>
</html>
